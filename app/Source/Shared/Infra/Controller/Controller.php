...
class Controller extends BaseController
{
    ...
    public function responseSuccess(mixed $data = [], int $code = Response::HTTP_OK, string $msg = ''): JsonResponse
    {
    ...
    public function responseError(mixed $data = [], int $code = Response::HTTP_BAD_REQUEST, string $msg = ''): JsonResponse
    {
        // Quando nenhuma mensagem informado, seta um default
        if (!$msg) {
            $msg = match ($code) {
